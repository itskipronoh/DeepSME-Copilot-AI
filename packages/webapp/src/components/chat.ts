...
export const chatDefaultOptions: ChatComponentOptions = {
  ...
  messages: [],
  strings: {
    promptSuggestionsTitle: 'Welcome to DeepSME Copilot! Ask me anything about your business or try these examples:',
    citationsTitle: 'Sources:',
    followUpQuestionsTitle: 'Related questions:',
    chatInputPlaceholder: 'Ask about taxes, permits, payments, or business guidance...',
    chatInputButtonLabel: 'Send question',
    assistant: 'DeepSME Copilot',
    user: 'You',
    errorMessage: 'We are currently experiencing an issue. Please try again later.',
