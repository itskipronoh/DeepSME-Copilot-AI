...
var finalOpenAiUrl = !empty(openAiUrl) ? openAiUrl : ''
var openAiInstanceName = empty(openAiUrl) ? '' : ''
...
module api './app/api.bicep' = {
  ...
  params: {
    ...
    appSettings: {
      ...
      AZURE_OPENAI_API_INSTANCE_NAME: openAiInstanceName
...
// System roles
module openAiRoleApi 'core/security/role.bicep' = if (empty(openAiUrl)) {
  scope: resourceGroup
